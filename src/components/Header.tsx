    ...
    <>
      ...
      <Flex
        ...
        <Flex
          ...
          {display.location && <Flex hide='s'>{"Asia/Kochi"}</Flex>}
        </Flex>
          ...
          <Flex
            ...
            <Flex gap='4' textVariant='body-default-s'>
...

              {
                <ToggleButton
                  prefixIcon='github'
                  href={`https://github.com/Sreehari78`}
                  selected={pathname.startsWith("/blog")}></ToggleButton>
              }
              {
                <ToggleButton
                  prefixIcon='linkedin'
                  href={`https://www.linkedin.com/in/sreehari7/`}
                  selected={pathname.startsWith("/gallery")}></ToggleButton>
              }
              {
                <ToggleButton
                  prefixIcon='email'
                  href={`mailto:shraxx7@gmail.com`}
                  selected={pathname.startsWith("/gallery")}></ToggleButton>
              }
            </Flex>
          </Flex>
